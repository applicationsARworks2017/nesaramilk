...
/**
 * Created by subharam on 3/21/2017.
 */

public class PayMentGateWayPayUbiz extends AppCompatActivity implements OneClickPaymentListener {

    private String merchantKey="Fwfhmc", userCredentials;
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        if (requestCode == PayuConstants.PAYU_REQUEST_CODE) {
            if (data != null) {
                 ...
                 * */
                String s= data.getStringExtra("payu_response");
                if(s.contains("\"status\":\"success\"")){
                    UpdateWallet();

                    final_status=" Payment Successful";
                }
                else{
                    final_status="Payment Failure";

                }

                new AlertDialog.Builder(this)
                        .setCancelable(false)
                        .setMessage(final_status)
    ...
    public void navigateToBaseActivity(View view) {
        ...
        String email = "amaresh.samantaray4@gmail.com";
        int environment;
        ...
        mPaymentParams.setAmount(getRechargeAmt);
        mPaymentParams.setProductInfo("nesaraproduct");
        mPaymentParams.setFirstName(getFirstName);
        mPaymentParams.setEmail("nesaramilk@gmail.com");
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, PayuHashes> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(PayMentGateWayPayUbiz.this);
        ...
        protected PayuHashes doInBackground(String... postParams) {
            ...
            try {
                ...
                URL url = new URL("http://nesaramilk.com/hashgeneration.php");
    ...
    public void launchSdkUI(PayuHashes payuHashes) {
        ...
        Intent intent = new Intent(PayMentGateWayPayUbiz.this, PayUBaseActivity.class);
    ...
    private class updateWal extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void user) {
            ...
            Intent intent=new Intent(PayMentGateWayPayUbiz.this,Home.class);
