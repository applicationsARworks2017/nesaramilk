...
import demosell.amaresh.android.com.nesara.Activity.ManageProducts;
...
public class AllProdudtAdapter extends BaseAdapter{
    Context _context;
    ArrayList<AllProducts> myList;
    Holder holder;

    public AllProdudtAdapter(ManageProducts home, ArrayList<AllProducts> prouct_list) {
        this._context=home;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final AllProducts unity_pos=myList.get(position);

        holder=new Holder();
        if (convertView == null) {
            LayoutInflater mInflater = (LayoutInflater)_context
                    .getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
            convertView = mInflater.inflate(R.layout.allproductlist,parent, false);
        ...
        if(unity_pos.getImage()=="" || unity_pos.getImage()==null || unity_pos.getImage().isEmpty()){
            ...
            Picasso.with(_context).load(unity_pos.getImage())
